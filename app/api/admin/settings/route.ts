...
export async function PATCH(request: NextRequest) {
  try { await requireAdmin(); const body = z.object({ biddingTimerSeconds: z.union([z.literal(0),z.literal(5),z.literal(10),z.literal(15),z.literal(20),z.literal(30),z.literal(45),z.literal(60)]).optional(), cardConfirmation: z.boolean().optional() }).parse(await request.json());
